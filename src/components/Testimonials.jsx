                ...
                <SwiperSlide>
                    <div className='flex flex-col sm:flex-row gap-4 bg-base-100 border rounded-md items-center '>
                        ...
                        <div className='p-4 space-y-4'>
                            <div><BiSolidQuoteRight className='text-4xl text-[#219653]'></BiSolidQuoteRight ></div>
                            ...
                            <div>
                                <div className='space-x-2'>
                                    ...
                                    <p className='text-lg text-white btn bg-[#219653] btn-square btn-xs rounded-none btn-ghost hover:bg-[#219653]'><SiTrustpilot></SiTrustpilot></p>
                                    <p className='text-lg text-white btn bg-[#219653] btn-square btn-xs rounded-none btn-ghost hover:bg-[#219653]'><SiTrustpilot></SiTrustpilot></p>
                                    <p className='text-lg text-white btn bg-[#219653] btn-square btn-xs rounded-none btn-ghost hover:bg-[#219653]'><SiTrustpilot></SiTrustpilot></p>
                                    <p className='text-lg text-white btn bg-[#219653] btn-square btn-xs rounded-none btn-ghost hover:bg-[#219653]'><SiTrustpilot></SiTrustpilot></p>
                                </div>
