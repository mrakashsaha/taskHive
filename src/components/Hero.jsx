            ...
            >
                        ...
                        <div className='bg-black/50 md:bg-transparent' >
                            <div className='w-11/12 lg:w-1/2 py-40 px-6'>
                                ...
                                <div className='font-medium mt-10 text-white flex justify-between'>
                                    <div>
                                        <h2 className='text-3xl font-bold'>920M</h2>
                                        <p className='text-xs'>Total Freelancer</p>
                                    </div>
                                    <div>
                                        <h2 className='text-3xl font-bold'>759M</h2>
                                        <p className='text-xs'>Positive Review</p>
                                    </div>
                                    <div>
                                        <h2 className='text-3xl font-bold'>130M</h2>
                                        <p className='text-xs'>Order recieved</p>
                                    </div>
                                    <div>
                                        <h2 className='text-3xl font-bold'>446M</h2>
                ...
                <SwiperSlide className='bg-cover bg-right bg-no-repeat' style={{
                    ...
                    <div className='container mx-auto'>
                        <div className='bg-black/50 md:bg-transparent' >
                            <div className='w-11/12 lg:w-1/2 py-40 px-6'>
                                <h2 className='text-white  text-3xl md:text-4xl lg:text-5xl font-semibold lg:leading-snug'>Unlock Limitless Opportunities, One Task at a Time</h2>
                    ...
                    <div className='container mx-auto'>
                        <div className='bg-black/50 md:bg-transparent' >
                            <div className='w-11/12 lg:w-1/2 py-40 px-6'>
                                ...
                                <div className='font-medium mt-10 text-white flex justify-between py-2'>
                                    <div>
                                        <h2 className='text-3xl font-bold'>920M</h2>
                                        <p className='text-xs'>Total Freelancer</p>
                                    </div>
