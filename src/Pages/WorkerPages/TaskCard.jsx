                    ...
                    <div className="card-body p-5">
                        <div className='relative'>
                            <div className="avatar absolute -top-10">
                                <div className="ring-white ring-offset-base-100 w-11 rounded-full ring ring-offset-1">
                        ...
                        <div className='flex justify-between items-center'>
                            <div>
                                <h5 className='text-[#333333] font-medium'>{task?.buyerName} <MdVerified className='inline-block text-[#6065fc]'></MdVerified> </h5>
                                <h5 className='text-[#333333] text-sm'>Deadline: <span className='font-medium'>{moment(task?.date).local().format("ll")}</span></h5>
                            </div>
                            <div>
