            ...
            <div className="hero"
                ...
                <div className="hero-content text-base-100 dark:text-white/80">
                    <div className="p-4 py-32 space-y-4 text-center">
                        <h2 className='text-3xl md:text-5xl font-medium leading-snug'>Answers to Your Most <br />
                            Common Questions</h2>
                        <p className='md:text-lg max-w-lg mx-auto text-center'>Explore our frequently asked questions to learn more about our services, processes, and how we can assist you.</p>
                    </div>
                </div>
            </div>
            ...
            <div className='p-4'>
                <div className='my-10'>
                    <div className='max-w-lg mx-auto text-center space-y-1'>
                        <p className='text-2xl md:text-3xl font-medium'>FAQ'S For Buyer</p>
                    ...
                    <div className='max-w-4xl mx-auto my-4 space-y-4'>
                        <div tabIndex={0} className="collapse collapse-arrow border-base-300 bg-base-100 border p-2">
                            <div className="collapse-title text-lg md:text-xl font-medium">1. How do I create a task on TaskHive?</div>
                        ...
                        <div tabIndex={0} className="collapse collapse-arrow border-base-300 bg-base-100 border p-2">
                            <div className="collapse-title text-lg md:text-xl font-medium">2. How do I pay workers on TaskHive?</div>
                            <div className="collapse-content">
                        ...
                        <div tabIndex={0} className="collapse collapse-arrow border-base-300 bg-base-100 border p-2">
                            <div className="collapse-title text-lg md:text-xl font-medium">3. What happens if I reject a worker's submission on TaskHive?</div>
                            <div className="collapse-content">
                        ...
                        <div tabIndex={0} className="collapse collapse-arrow border-base-300 bg-base-100 border p-2">
                            <div className="collapse-title text-lg md:text-xl font-medium">4. How do I purchase TaskHive coins?</div>
                            <div className="collapse-content">
                        ...
                        <div tabIndex={0} className="collapse collapse-arrow border-base-300 bg-base-100 border p-2">
                            <div className="collapse-title text-lg md:text-xl font-medium">5. Can I update or delete a task after posting it on TaskHive?</div>
                            <div className="collapse-content">
                        ...
                        <div tabIndex={0} className="collapse collapse-arrow border-base-300 bg-base-100 border p-2">
                            <div className="collapse-title text-lg md:text-xl font-medium">6. How do I track my payment history on TaskHive?</div>
                            <div className="collapse-content">
                ...
                <div className='my-20'>
                    <div className='max-w-lg mx-auto text-center space-y-1'>
                        <p className='text-2xl md:text-3xl font-medium'>FAQ'S For Worker</p>
                        <p className='text-lg'>Your Questions, Answered</p>
                    </div>
                    <div className='max-w-4xl mx-auto my-4 space-y-4'>
                        <div tabIndex={0} className="collapse collapse-arrow border-base-300 bg-base-100 border p-2">
                            <div className="collapse-title text-lg md:text-xl font-medium">1. How do I find tasks to complete on TaskHive?</div>
                            <div className="collapse-content">
                        ...
                        <div tabIndex={0} className="collapse collapse-arrow border-base-300 bg-base-100 border p-2">
                            <div className="collapse-title text-lg md:text-xl font-medium">2. How do I submit a completed task on TaskHive?</div>
                            <div className="collapse-content">
                        ...
                        <div tabIndex={0} className="collapse collapse-arrow border-base-300 bg-base-100 border p-2">
                            <div className="collapse-title text-lg md:text-xl font-medium">3. How do I get paid for completed tasks on TaskHive?</div>
                            <div className="collapse-content">
                        ...
                        <div tabIndex={0} className="collapse collapse-arrow border-base-300 bg-base-100 border p-2">
                            <div className="collapse-title text-lg md:text-xl font-medium">4. What happens if my submission is rejected on TaskHive?</div>
                            <div className="collapse-content">
                        ...
                        <div tabIndex={0} className="collapse collapse-arrow border-base-300 bg-base-100 border p-2">
                            <div className="collapse-title text-lg md:text-xl font-medium">5. What is the minimum amount I can withdraw on TaskHive?</div>
                            <div className="collapse-content">
                                <p>The minimum withdrawal amount is 200 TaskHive coins, which is equivalent to $10.</p>
                            </div>
                        </div>
                        <div tabIndex={0} className="collapse collapse-arrow border-base-300 bg-base-100 border p-2">
                            <div className="collapse-title text-lg md:text-xl font-medium">6. Can I see the status of my submissions on TaskHive?</div>
                            <div className="collapse-content">
